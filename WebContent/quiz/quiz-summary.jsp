...
<html>
   ...
   <body>
      ...
      <div class="top">
         ...
         <span class="header-link"><a href="/Quizness/profile.jsp">Profile</a></span>
         <span class="header-link"><a href="/Quizness/site/admin.jsp">Admin</a></span>
         <span class="header-link"><a href="/Quizness/inbox.jsp">Inbox</a></span>
      </div>
         ...
         <form method="post" action="../quiz/quiz-summary.jsp?quiz_id=<%=quizID %>" id="signup">
            ...
            <div class="inputs">
               ...
               <p><%=formatter.format(recentTries.get(i).getDate()) %> 
                  <a href="/Quizness/profile.jsp?id=<%=userID%>"><%=userName%></a> scored <%=NumberConverter.toString(recentTries.get(i).getScore()) %> 
               </p>
               <%
                  }
                  %>
      ...
      <div class="container" style="float:left;padding-left:50px;">
         <form method="post" action="" id="signup">
            ...
            <p><%=formatter.format(bestTriesToday.get(i).getDate()) %>
               <a href="/Quizness/profile.jsp?id=<%=userID%>"><%=userName + " " %></a> scored <%= " " + NumberConverter.toString(bestTriesToday.get(i).getScore()) %> 
            </p>
            <%
               }
               %>
