...
<body>
      ...
      <form method="post" action="../../EditServlet" id="signup">
         ...
         <div class="inputs">
            ...
            <table id="contents" class="inputs">
               ...
               <tfoot>
                  <tr>
                     <td align="center" class="terms"><a href="#" id="new_solution">Add A Solution</a></td>
                  </tr>
               </tfoot>
            </table>
   ...
   <script type="text/javascript">
      var syn_button = document.getElementById("new_solution");
      syn_button.addEventListener("click", function() {
      	var body = document.getElementById("contents");
      	body.insertAdjacentHTML('beforeend',	'<tr>' +
      			'<td><input type="name" name="correct_answer_text" style="width:100%" placeholder="New Solution"></td>' +
      			'<td><input type="name" name="correct_asnwer_score" style="width:100%" /></td>' +
      			'</tr>');
